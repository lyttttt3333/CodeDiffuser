...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_dir", default=f"/home/yitong/diffusion/data_train/check")
    ...
    parser.add_argument("--assign_num", default=True, type=bool)
    ...
    for i in tqdm(
        ...
        retry = 0
        if i < 30:
            num_obj_done = i % args.num_obj_done
            num_obj_wait = 1
        elif i>=30 and i<60:
            num_obj_done = i % args.num_obj_done
            num_obj_wait = 2
